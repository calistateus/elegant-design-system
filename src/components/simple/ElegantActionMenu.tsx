...
function SubMenuItemButton({
  ...
  const hoverBg   = item.danger ? 'var(--primitive-red-100)' : 'var(--primitive-gray-50)';
...
function ActionMenuItemButton({
  ...
  const hoverBg   = isDanger ? 'var(--primitive-red-100)' : 'var(--primitive-gray-50)';
    ...
    <div style={{ position: 'relative', display: 'inline-block' }}>
      ...
      <button
        ...
        style={{
          ...
          backgroundColor: open || triggerHovered ? 'var(--primitive-gray-100)' : 'transparent',
