    ...
    <div className="elegant-field">
      ...
      <div
        ...
        style={{
          ...
          border: `1px solid ${hasError ? 'var(--color-error-border)' : 'var(--color-border-input)'}`,
        ...
        <div style={{ display: 'flex', position: 'relative', height: drumHeight }}>
          ...
          {columns.map((col, i) => (
            <WheelDrum
              ...
              showDivider={i > 0}
              columnLabel={col.label ?? `Column ${i + 1}`}
            />
          ))}
        </div>
      </div>
  ...
  return (
    <div
      ...
      style={{
        ...
        borderLeft: showDivider ? '1px solid var(--color-border-default)' : 'none',
        outline: 'none',
