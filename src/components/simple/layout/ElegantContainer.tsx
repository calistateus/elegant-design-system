...
type ContainerElement = 'div' | 'section' | 'article' | 'main' | 'aside' | 'header' | 'footer' | 'nav';
...
export interface ElegantContainerProps {
  /** HTML element to render as */
  as?: ContainerElement;
  /** Constrains horizontal width. 'page' uses the system max-width (1280px). */
  maxWidth?: MaxWidth;
...
export function ElegantContainer({
  as: Tag = 'div',
  maxWidth,
  center = false,
  paddingX = 'none',
