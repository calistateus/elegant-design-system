...
function ImageSlide({ src, alt, caption, ratio, onUpload }: ImageSlideProps) {
  ...
  return (
    ...
    >
      ...
      <span style={{ fontFamily: 'var(--primitive-font-sans)', fontSize: 'var(--primitive-font-size-xs)', fontWeight: 'var(--primitive-font-weight-regular)', letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--color-text-muted)' }}>
        Upload image
      </span>
    </div>
  );
        ...
        <div style={{ flex: 1, minWidth: 0, overflowX: 'hidden' }}>
          <div
            style={{
              ...
              transition: `transform var(--primitive-duration-relaxed) var(--primitive-easing-power2-out)`,
              alignItems: 'stretch',
            }}
          >
            {slides.map((slide, i) => (
