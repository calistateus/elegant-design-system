...
export function ElegantPagination({
  ...
  const navBtnStyle = (enabled: boolean): React.CSSProperties => ({
    ...
    color: enabled ? 'var(--color-text-body)' : 'var(--primitive-gray-300)',
  ...
  const pageBtnStyle = (isActive: boolean): React.CSSProperties => ({
    ...
    border: isActive ? '1px solid var(--primitive-black)' : '1px solid transparent',
    borderRadius: 'var(--primitive-radius-md)',
  ...
  return (
    ...
    >
      ...
      <button
        ...
        onMouseEnter={e => {
          if (!canPrev) return;
          e.currentTarget.style.borderColor = 'var(--primitive-gray-400)';
          e.currentTarget.style.color = 'var(--color-text-title)';
        }}
        onMouseLeave={e => {
          if (!canPrev) return;
          e.currentTarget.style.borderColor = 'var(--primitive-gray-200)';
